...
t.test(day3 ~ treatment_no, data = rairuoho_1, var.equal=T )
my.t.test(rairuoho_1$day4, rairuoho_1$treatment_no)
t.test(day4 ~ treatment_no, data = rairuoho_1, var.equal=T )
my.t.test(rairuoho_1$day5, rairuoho_1$treatment_no)
t.test(day5 ~ treatment_no, data = rairuoho_1, var.equal=T )
my.t.test(rairuoho_1$day6, rairuoho_1$treatment_no)
t.test(day6 ~ treatment_no, data = rairuoho_1, var.equal=T )
...
t.test(day8 ~ treatment_no, data = rairuoho_1, var.equal=T )
```
